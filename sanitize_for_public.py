...
def get_replacement_mappings(target_company: str = 'company', target_team: str = 'sirt') -> Dict[str, str]:
    ...
    return {
        ...
        r'\.internal\.net': '.internal.example.com',
        r'internal\.net': 'internal.example.com',
        rf'{source_team_lower}-lab-12\.internal\.net': 'lab-server.example.com',
        r'lab-vm-12\.internal\.net': 'lab-vm.example.com',
        ...
        r'USHZK3C64\.internal\.net': 'TEST-HOST-002.internal.example.com',
