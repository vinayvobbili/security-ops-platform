...
def check_auth(username, password):
    ...
    return username == "lab" and password == auth_password
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='lab',
        help='Password for HTTP Basic Auth (default: lab)'
    )
...
def main():
    ...
    logger.info(f"Auth: username=lab, password={auth_password}")
