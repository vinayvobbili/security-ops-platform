...
echo -n "lab" | sudo htpasswd -i -c /home/vinay/pub/IR/.htpasswd lab
sudo chown vinay:vinay /home/vinay/pub/IR/.htpasswd
sudo chmod 644 /home/vinay/pub/IR/.htpasswd
echo "  ✓ Password configured (username: lab, password: lab)"
echo ""
...
echo ""
echo "Landing page:"
echo "  http://lab-vm1.internal.company.com:8030"
echo "  (Username: lab, Password: lab)"
echo ""
echo "Direct access URLs:"
echo "  http://lab-vm1.internal.company.com:8031 - All Services (journalctl)"
...
echo "  http://lab-vm1.internal.company.com:8035 - the orchestration service"
echo "  http://lab-vm1.internal.company.com:8036 - the alert triage service"
echo "  http://lab-vm1.internal.company.com:8038 - the threat-intel service"
...
echo "  ssh -L 8030:localhost:8030 -L 8031:localhost:8031 -L 8032:localhost:8032 -L 8033:localhost:8033 -L 8034:localhost:8034 -L 8035:localhost:8035 -L 8036:localhost:8036 -L 8037:localhost:8037 -L 8038:localhost:8038 lab-lab"
