...
echo "  All Jobs:      http://localhost:8037 (user: sirt, pass: sirt)"
echo "  Barnacles:     http://localhost:8031 (user: sirt, pass: sirt)"
echo "  MSOAR:         http://localhost:8032 (user: sirt, pass: sirt)"
echo "  MoneyBall:     http://localhost:8033 (user: sirt, pass: sirt)"
echo "  Toodles:       http://localhost:8034 (user: sirt, pass: sirt)"
echo "  Jarvis:        http://localhost:8036 (user: sirt, pass: sirt)"
echo ""
