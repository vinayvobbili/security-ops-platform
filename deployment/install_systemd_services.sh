...
echo "  All services:  http://localhost:8030 (user: lab, pass: lab)"
echo "  All Jobs:      http://localhost:8037 (user: lab, pass: lab)"
echo "  the alert triage service:     http://localhost:8031 (user: lab, pass: lab)"
echo "  the case orchestrator:         http://localhost:8032 (user: lab, pass: lab)"
echo "  MoneyBall:     http://localhost:8033 (user: lab, pass: lab)"
echo "  the notification service:       http://localhost:8034 (user: lab, pass: lab)"
echo "  the orchestration service:        http://localhost:8036 (user: lab, pass: lab)"
echo ""
