...
start_viewers() {
    ...
    # Port 8041: CASE
    nohup /home/vinay/pub/IR/.venv/bin/python deployment/log_viewer.py --port 8041 --title "CASE Bot" --file /home/vinay/pub/IR/logs/case.log >> logs/log_viewer_case.log 2>&1 &
