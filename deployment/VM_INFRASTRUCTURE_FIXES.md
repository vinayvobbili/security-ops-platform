# VM Infrastructure Fixes for lab-lab

This document describes infrastructure improvements made to the lab-lab VM to address reliability and performance issues.
...
- `ir-msoar` - the case orchestrator bot
- `ir-money-ball` - MoneyBall bot
- `ir-toodles` - the notification service bot
- `ir-barnacles` - the alert triage service bot
- `ir-jarvis` - the orchestration service bot
