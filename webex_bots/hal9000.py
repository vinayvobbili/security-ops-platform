# -*- coding: utf-8 -*-
"""
the notification service Webex Bot - Main Application File
"""
...
DEFAULT_BOT_NAME: str = "the notification service"
...
def get_url_card() -> dict:
    ...
    try:
        lab_urls = list_handler.get_list_data_by_name(URL_LIST_NAME)
        # Ensure lab_urls is a list, even if empty
        if not isinstance(lab_urls, list):
            logger.error(f"Data retrieved for '{URL_LIST_NAME}' is not a list: {type(lab_urls)}. Treating as empty.")
            lab_urls = []
