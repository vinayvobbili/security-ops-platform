# the security assistant bot SOC Bot - Clean and reliable version
import csv
import logging
import os
import signal
...
class PokeDxBot(WebexBot):
    """Streamlined the security assistant bot bot"""
...
def main():
    ...
    try:
        ...
        print(f"🚀 the security assistant bot is up and running with llama3.1:70b (startup in {init_duration:.1f}s)...")
        logger.info(f"🚀 the security assistant bot is up and running (startup in {init_duration:.1f}s)...")
