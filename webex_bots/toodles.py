...
class AZDOWorkItem(Command):
    ...
    def execute(self, message, attachment_actions, activity):
        ...
        try:
            ...
            lab_xsoar = list_handler.get_list_data_by_name('METCIRT XSOAR')
            api_token = lab_xsoar['AZDO_PAT']['us-2' if project == 'gdr' else 'us']
            ...
            payload_json = {
                'roomId': webex_data.get("channels").get("lab_automation" if project == 'platforms' else "response_engineering"),
...
def main():
    bot = WebexBot(
        ...
        bot_name="Hello from the notification service!",
