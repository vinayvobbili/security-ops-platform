...
def get_url_card():
    ...
    """
    try:
        lab_urls = prod_list_handler.get_list_data_by_name('METCIRT URLs')
        actions = []
...
def toodles_initialization_with_tracking(bot_instance, resilient_runner):
    """Initialize the notification service with message activity tracking for idle detection"""
...
def main():
    """the notification service main - always uses resilience framework"""
    ...
    resilient_runner = ResilientBot(
        ...
        peer_bot_email=config.webex_bot_email_jarvis,  # the notification service → the orchestration service
