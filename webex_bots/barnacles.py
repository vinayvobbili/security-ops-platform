...
def main():
    """the alert triage service main - toggle resilience framework based on SHOULD_USE_RESILIENCY flag"""
    if SHOULD_USE_RESILIENCY:
        logger.info("Starting the alert triage service with resilience framework (SSL config, device cleanup, auto-restart)")
