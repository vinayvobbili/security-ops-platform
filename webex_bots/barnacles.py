...
def run_bot_with_reconnection():
    ...
    for attempt in range(max_retries):
        try:
            logger.info(f"Starting the alert triage service bot (attempt {attempt + 1}/{max_retries})")
            ...
            print("⚓ the alert triage service is up and running with enhanced features...")
