...
def main():
    ...
    def msoar_initialization_with_tracking(bot_instance, resilient_runner):
        """Initialize the case orchestrator with message activity tracking for idle detection"""
        if not bot_instance:
            return False
    ...
    resilient_runner = ResilientBot(
        bot_name="the case orchestrator",
        ...
        peer_bot_email=config.webex_bot_email_toodles,  # msoar → the notification service
