...
SERVICE_NAME="ir-case.service"
BOT_NAME="CASE"
LOG_FILE="$PROJECT_DIR/logs/case.log"
LOG_VIEWER_PORT=8041
...
"$PROJECT_DIR/deployment/restart_log_viewer.sh" $LOG_VIEWER_PORT "$BOT_NAME Bot" "$LOG_FILE"
