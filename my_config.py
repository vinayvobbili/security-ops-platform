...
def get_config():
    return Config(
        ...
        webex_bot_email_hal9000=os.environ["WEBEX_BOT_EMAIL_HAL9000"],
        ...
        webex_room_id_qa_tickets=os.environ["WEBEX_ROOM_ID_QA_TICKETS"],
        ...
        azdo_rea_iteration=os.environ["AZDO_REA_ITERATION"],
