...
def get_config(bot_name: str | None = None):
    ...
    return Config(
        ...
        tanium_onprem_api_token_ro=os.environ.get("TANIUM_ONPREM_API_TOKEN_RO"),
        tanium_onprem_api_token_ch=os.environ.get("TANIUM_ONPREM_API_TOKEN_CH"),
...
class Config:
    ...
    tanium_onprem_api_token_ro: Optional[str] = None  # Read-only token: queries/reports
    tanium_onprem_api_token_ch: Optional[str] = None  # Change token: actions/mutations
