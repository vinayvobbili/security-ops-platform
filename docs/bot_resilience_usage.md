...
## Example: Converting the notification service Bot
...
def main():
    """the notification service main with resilience"""
    from src.utils.bot_resilience import BotResilient
...
- [x] the security assistant bot ✅
- [x] the notification service ✅
- [x] Jarvais ✅
- [x] the alert triage service ✅
- [x] HAL9000 ✅
- [x] MoneyBall ✅
