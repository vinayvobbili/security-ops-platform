...
- **`webex_bots/`** - Multiple specialized chatbots (the security assistant bot, the orchestration service, the alert triage service, etc.)
...
#### SOC Bot (the security assistant bot)
