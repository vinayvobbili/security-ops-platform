...
- `lab-vm1.internal.company.com` (20+ occurrences)
...
**Personal File Paths:**
- `/Users/<redacted-email>/PycharmProjects/IR` (15+ occurrences)
...
**Credentials in Code:**
- `deployment/log_viewer.py` - Username: `lab`, Password: `lab`
- `deployment/install_systemd_services.sh` - Echo credentials
- `deployment/setup_log_viewers.sh` - htpasswd setup with lab credentials
