...
**Example URL:**
```
http://lab-vm1.internal.company.com/api/countdown-timer?deadline=2025-11-11T15:00:00-05:00&title=Time%20to%20Respond
```
...
```python
WEB_SERVER_BASE_URL = "http://lab-vm1.internal.company.com"  # Update to your server
```
...
1. Create a test HTML file:
   ...
   <body>
       <h1>Test Email</h1>
       <img src="http://lab-vm1.internal.company.com/api/countdown-timer?deadline=2025-11-11T15:00:00-05:00"
            alt="Countdown Timer"
...
curl "http://lab-vm1.internal.company.com/api/countdown-timer?deadline=2025-12-01T12:00:00-05:00"
