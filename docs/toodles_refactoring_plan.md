# the notification service Bot Refactoring Plan
...
2. **Create base command classes** (Pattern #2)
   ...
   - Implement `the notification serviceCommand` base class
...
├── base/
│   ├── __init__.py
│   └── toodles_command.py         # the notification serviceCommand, CardOnlyCommand
├── cards/
│   ├── __init__.py                # Export all cards
