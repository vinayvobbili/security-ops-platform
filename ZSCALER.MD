...
- [x] the security assistant bot bot starts and connects successfully (WebSocket connected)
...
- the security assistant bot bot verified running with WebSocket successfully connected