...
Currently used by: the security assistant bot
...
class ZScalerResilientBot:
    ...
    Usage:
        # For the security assistant bot (currently affected)
        resilient_runner = ZScalerResilientBot(..., bot_name="the security assistant bot")
    ...
    def run(self):
        """Run the the security assistant bot bot with ZScaler-aware resilience"""
