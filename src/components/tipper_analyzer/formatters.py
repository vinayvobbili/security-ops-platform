...
<h3>🤖 Tipper Novelty Analysis (the security assistant bot)</h3>
...
<hr/>
<p><em>Generated by the security assistant bot Tipper Analyzer</em></p>
</div>"""
...
def format_single_tool_hunt_for_azdo(
    ...
    html_parts.append(f"<p><em>Generated by the security assistant bot IOC Hunter</em></p>")
    html_parts.append("</div>")
...
def format_hunt_results_for_azdo(result: IOCHuntResult, rf_enrichment: dict = None) -> str:
    ...
    html_parts.append("<p><em>Generated by the security assistant bot IOC Hunter</em></p>")
    html_parts.append("</div>")
