...
<h3>🤖 Tipper Novelty Analysis (Sleuth)</h3>
...
<hr/>
<p><em>Generated by Sleuth Tipper Analyzer</em></p>
</div>"""
...
def format_single_tool_hunt_for_azdo(
    ...
    html_parts.append(f"<p><em>Generated by Sleuth IOC Hunter</em></p>")
...
def format_hunt_results_for_azdo(result: IOCHuntResult, rf_enrichment: dict = None) -> str:
    ...
    html_parts.append("<p><em>Generated by Sleuth IOC Hunter</em></p>")
    html_parts.append("</div>")
