...
def check_sleuth_status(get_state_manager_func) -> Dict[str, Any]:
    ...
    try:
        ...
        if not state_manager:
            return {
                ...
                'instructions': [
                    'Restart the web server with ENABLE_SLEUTH_CHAT = True'
                ]
            }

        # Lazy-initialize if startup was skipped (SKIP_SLEUTH_WARMUP)
