...
def authenticate_aide(password: str, configured_password: str) -> Tuple[bool, str]:
    """Authenticate user for the notification service.
    ...
    """
    logger.debug("Authenticating the notification service user")

    if not configured_password:
        logger.error("AIDE_PASSWORD not configured in .env file")
