...
def process_ticket(ticket):
    ...
    incident_sla = ticket.get('CustomFields', {}).get('labincidentnotificationsla', {})
...
def start(room_id):
    ...
    try:
        ...
        query = f'-status:closed -category:job type:{CONFIG.team_name} labincidentnotificationsla.runStatus:running labincidentnotificationsla.slaStatus:2'
        ...
        for ticket in tickets:
            ...
            incident_sla = ticket_data.get('CustomFields', {}).get('labincidentnotificationsla', {})
            breach_triggered = incident_sla.get('breachTriggered', False)
            run_status = incident_sla.get('runStatus', '')
