...
def start(room_id):
    ...
    query = '-status:closed -category:job type:METCIRT timetorespond.runStatus:running timetorespond.slaStatus:risk'
    ...
    markdown_header = "## ⚠️ Tickets at risk of Response SLA breach 🚨"
    markdown_message = "\n".join(message)
