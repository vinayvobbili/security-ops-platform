#!/bin/bash
# Start MacBook Sleep Monitor for the security assistant bot Bot

# Get project directory (3 levels up from this script)
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
PROJECT_DIR="$(cd "$SCRIPT_DIR/../.." && pwd)"
SCRIPT_PATH="$PROJECT_DIR/src/sleuth/macbook_sleep_monitor.py"
...
echo "Starting MacBook Sleep Monitor for the security assistant bot..."
echo ""
