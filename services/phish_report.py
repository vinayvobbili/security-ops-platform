...
def build_report_html(result: Dict[str, Any], generated_at: Optional[str] = None) -> str:
    ...
    header = (
        ...
        f'the company Cyber &middot; on-prem LLM analysis &middot; generated {_e(generated_at)}</div>'
        f'</td></tr></table>'
    )
    ...
    footer = (
        ...
        'Generated by the the company Cyber phishing analysis tool — runs entirely on on-prem LLM infrastructure '
