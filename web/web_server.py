...
try:
    ...
    print(f"⚠️ the security assistant bot components unavailable: {e}. Continuing with limited functionality.")
...
def api_toodles_login():
    ...
    try:
        ...
        logger.error(f"Error in the notification service login: {exc}")
        return jsonify({'success': False, 'error': str(exc)}), 500
