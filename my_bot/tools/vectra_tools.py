...
def search_vectra_entity_by_ip(ip_address: str) -> str:
    ...
    Args:
        ip_address: The IP address to search for (e.g., "<internal-host>")
    """
    client = _get_vectra_client()
    if not client:
        return "Error: Vectra service is not available."
...
#   "Search Vectra for IP <internal-host>"
#   "What does Vectra have on <internal-host>?"
#   "Check <internal-host> in Vectra"
#
...
#   "Check if <internal-host> has any Vectra detections"
