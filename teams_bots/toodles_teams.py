#!/usr/bin/env python3
"""
Teams Bot Framework Bot for the notification service
Provides same functionality as Webex the notification service bot via Teams Bot Framework with websockets
...
def main():
    ...
    """
    logger.info("Starting the notification service Teams Bot with Bot Framework...")
