...
def teams_webhook():
    ...
    try:
        ...
        if command in TEAMS_COMMANDS:
            ...
            return jsonify({
                'type': 'message',
                'text': f"❓ Unknown command '{command}'. Type `@aide help` for available commands."
            })
...
def root():
    ...
    return jsonify({
        ...
        'setup_instructions': {
            ...
            'step_3': 'Set bot name to: aide',
            'step_4': 'Test with: @aide help'
        },
        'health_check': '/health',
...
if __name__ == '__main__':
    ...
    logger.info("📋 Test command: @aide help")
