...
WORKFLOW_DIR="${WORKFLOW_DIR:-/home/vinay/security-ops-platform/n8n_workflows}"
BACKUP_DIR="${BACKUP_DIR:-/home/vinay/security-ops-platform/n8n_workflows/.backups}"
...
case "${1:-}" in
    ...
    *)
        ...
        echo "  WORKFLOW_DIR   Workflow directory (default: /home/vinay/security-ops-platform/n8n_workflows)"
        echo ""
        echo "Example:"
